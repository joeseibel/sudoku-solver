...
class YWingTest {
    ...
    public void test1() {
        var board = """
                ...
                51{348}{34}79{48}62
                2{34}7{1345}86{145}{45}9""".replace("\n", "");
        var expected = List.of(
                new RemoveCandidates(1, 0, 8),
                new RemoveCandidates(2, 0, 8),
                new RemoveCandidates(7, 2, 4)
        );
        SudokuAssertions.assertLogicalSolution(expected, board, YWing::yWing);
    }
    ...
    public void test2() {
        var board = """
                ...
                8{16}{13}{3467}{347}{3467}529""".replace("\n", "");
        var expected = List.of(
                new RemoveCandidates(7, 1, 9),
                new RemoveCandidates(7, 3, 6)
        );
        SudokuAssertions.assertLogicalSolution(expected, board, YWing::yWing);
    }
    ...
    public void test3() {
        var board = """
                ...
                258{19}37{19}46
                649{12}8{125}3{15}7
                1374{59}6{589}{589}2""".replace("\n", "");
        var expected = List.of(
                new RemoveCandidates(0, 4, 9),
                new RemoveCandidates(1, 7, 9)
        );
        SudokuAssertions.assertLogicalSolution(expected, board, YWing::yWing);
    }
    ...
    public void test4() {
        ...
        var expected = List.of(
                ...
                new RemoveCandidates(3, 7, 1, 6),
                new RemoveCandidates(4, 6, 7),
                new RemoveCandidates(7, 6, 6),
