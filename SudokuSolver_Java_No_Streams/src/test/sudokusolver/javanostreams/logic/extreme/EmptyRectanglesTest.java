...
class EmptyRectanglesTest {
    ...
    public void test1() {
        var board = """
                ...
                74835{16}29{16}
                {36}{16}{136}279854""".replace("\n", "");
        var expected = List.of(new RemoveCandidates(3, 8, 6));
        SudokuAssertions.assertLogicalSolution(expected, board, EmptyRectangles::emptyRectangles);
    }
    ...
    public void test2() {
        var board = """
                ...
                {58}97{28}16{2458}3{248}""".replace("\n", "");
        var expected = List.of(
                new RemoveCandidates(4, 8, 6),
                new RemoveCandidates(7, 2, 6)
        );
        SudokuAssertions.assertLogicalSolution(expected, board, EmptyRectangles::emptyRectangles);
    }
    ...
    public void test3() {
        ...
        var expected = List.of(new RemoveCandidates(8, 4, 3));
        SudokuAssertions.assertLogicalSolution(expected, board, EmptyRectangles::emptyRectangles);
    }
    ...
    public void test4() {
        var board = """
                ...
                {2345}168{23457}{2457}{237}9{237}""".replace("\n", "");
        var expected = List.of(
                new RemoveCandidates(0, 3, 7),
                new RemoveCandidates(0, 8, 7),
                new RemoveCandidates(7, 7, 7),
                new RemoveCandidates(8, 4, 2)
        );
        SudokuAssertions.assertLogicalSolution(expected, board, EmptyRectangles::emptyRectangles);
    }
    ...
    public void test5() {
        var board = """
                ...
                {2345}168{345}{45}{237}9{237}""".replace("\n", "");
        var expected = List.of(new RemoveCandidates(6, 7, 3));
        SudokuAssertions.assertLogicalSolution(expected, board, EmptyRectangles::emptyRectangles);
    }
}