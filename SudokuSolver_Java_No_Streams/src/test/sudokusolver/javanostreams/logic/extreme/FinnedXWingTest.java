...
class FinnedXWingTest {
    ...
    public void test1() {
        var board = """
                ...
                {346}1{37}5{23679}{24679}{347}{267}8""".replace("\n", "");
        var expected = List.of(new RemoveCandidates(7, 8, 7));
        SudokuAssertions.assertLogicalSolution(expected, board, FinnedXWing::finnedXWing);
    }
    ...
    public void test2() {
        var board = """
                ...
                {345}7{35}162{45}98
                89{25}734{25}61
                {124}{146}{126}859{24}73""".replace("\n", "");
        var expected = List.of(new RemoveCandidates(5, 0, 3, 5));
        SudokuAssertions.assertLogicalSolution(expected, board, FinnedXWing::finnedXWing);
    }
    ...
    public void test3() {
        var board = """
                ...
                89{25}734{25}61
                {124}{146}{126}859{24}73""".replace("\n", "");
        var expected = List.of(new RemoveCandidates(5, 0, 5));
        SudokuAssertions.assertLogicalSolution(expected, board, FinnedXWing::finnedXWing);
    }

    @Test
    public void testSashimi() {
        var board = """
                3{467}{67}{46}12598
                ...
                8{67}452{67}139""".replace("\n", "");
        var expected = List.of(
                new RemoveCandidates(4, 5, 4),
                new RemoveCandidates(5, 5, 4)
        );
        SudokuAssertions.assertLogicalSolution(expected, board, FinnedXWing::finnedXWing);
    }
}