...
class AlignedPairExclusionTest {
    @Test
    public void test1() {
        var board = """
                ...
                36{1258}{2458}{258}{25}{2489}7{1289}""".replace("\n", "");
        var expected = List.of(
                new RemoveCandidates(6, 2, 8),
                new RemoveCandidates(7, 6, 8)
        );
        SudokuAssertions.assertLogicalSolution(expected, board, AlignedPairExclusion::alignedPairExclusion);
    }
    ...
    public void test2() {
        var board = """
                ...
                {48}{124}9736{248}5{12}
                36{1258}{2458}{258}{25}{2489}7{1289}""".replace("\n", "");
        var expected = List.of(new RemoveCandidates(7, 6, 8));
        SudokuAssertions.assertLogicalSolution(expected, board, AlignedPairExclusion::alignedPairExclusion);
    }
    ...
    public void test3() {
        var board = """
                ...
                8{15}{57}6342{17}9
                {13479}{134}{3479}2{58}{19}{13467}{3678}{1357}""".replace("\n", "");
        var expected = List.of(
                new RemoveCandidates(2, 1, 1),
                new RemoveCandidates(2, 2, 3)
        );
        SudokuAssertions.assertLogicalSolution(expected, board, AlignedPairExclusion::alignedPairExclusion);
    }
    ...
    public void test4() {
        var board = """
                ...
                {1349}62{19}{58}7{134}{138}{135}
                8{15}{57}6342{17}9
                {13479}{134}{3479}2{58}{19}{13467}{3678}{157}""".replace("\n", "");
        var expected = List.of(
    ...
    public void test5() {
        var board = """
                ...
                {124}83{679}{26}{149}{126}{1569}{157}""".replace("\n", "");
        var expected = List.of(
    ...
    public void test7() {
        var board = """
                ...
                {89}647{59}1{58}23""".replace("\n", "");
        var expected = List.of(
                new RemoveCandidates(1, 0, 1),
                new RemoveCandidates(1, 1, 1),
                new RemoveCandidates(2, 8, 1),
    ...
    public void test12() {
        var board = """
                ...
                {579}63{45}{47}1{2579}{2579}8""".replace("\n", "");
        var expected = List.of(
                new RemoveCandidates(1, 4, 4),
                new RemoveCandidates(2, 4, 4),
                new RemoveCandidates(4, 5, 4)
        );
        SudokuAssertions.assertLogicalSolution(expected, board, AlignedPairExclusion::alignedPairExclusion);
    }
    ...
    public void test13() {
        var board = """
                ...
                84{579}2{67}{567}{579}13
                {579}63{45}{47}1{2579}{2579}8""".replace("\n", "");
        var expected = List.of(new RemoveCandidates(4, 4, 2));
        SudokuAssertions.assertLogicalSolution(expected, board, AlignedPairExclusion::alignedPairExclusion);
    }
    ...
    public void test14() {
        ...
        var expected = List.of(
                new RemoveCandidates(4, 0, 4, 8),
                new RemoveCandidates(4, 2, 4, 8),
