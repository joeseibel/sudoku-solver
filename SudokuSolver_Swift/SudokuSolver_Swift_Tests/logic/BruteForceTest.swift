...
final class BruteForceTest: XCTestCase {
    func testBruteForceSingleSolution() {
        ...
        XCTAssertNoThrow(XCTAssertEqual(parse(board: expected), try bruteForce(board: parse(optionalBoard: board))))
    }
    ...
    func testBruteForceNoSolutions() {
        ...
        XCTAssertThrowsError(try bruteForce(board: parse(optionalBoard: board))) {
    ...
    func testBruteForceAlreadySolved() {
        ...
        XCTAssertNoThrow(XCTAssertEqual(parse(board: board), try bruteForce(board: parse(optionalBoard: board))))
    }
