...
class UniqueRectanglesTest {
    @Test
    public void type1Test1() {
        var board = """
                {79}{79}6324815
                85{23}691{24}7{34}
                ...
                {146}{14}82597{36}{346}""".replace("\n", "");
        var expected = List.of(new RemoveCandidates(3, 0, 2, 9));
        SudokuAssertions.assertLogicalSolution(expected, board, UniqueRectangles::uniqueRectanglesType1);
    }

    @Test
    public void type1Test2() {
        var board = """
                ...
                732591648
                165748923""".replace("\n", "");
        var expected = List.of(new RemoveCandidates(0, 6, 2, 5));
        SudokuAssertions.assertLogicalSolution(expected, board, UniqueRectangles::uniqueRectanglesType1);
    }

    @Test
    public void type1Test3() {
        var board = """
                ...
                2{46}{46}137958
                {37}{17}5698{13}24
                {389}{19}{389}452{13}76""".replace("\n", "");
        var expected = List.of(new RemoveCandidates(3, 0, 7, 8));
        SudokuAssertions.assertLogicalSolution(expected, board, UniqueRectangles::uniqueRectanglesType1);
    }

    @Test
    public void type1Test4() {
        var board = """
                12{58}{568}{568}7943
                96{35}{345}1{34}872
                47{38}9{238}{238}156
                ...
                2347{68}15{68}9""".replace("\n", "");
        var expected = List.of(new RemoveCandidates(6, 4, 6, 8));
        SudokuAssertions.assertLogicalSolution(expected, board, UniqueRectangles::uniqueRectanglesType1);
    }

    @Test
    public void type2Test1() {
        var board = """
                ...
                6827{15}{15}439
                {35}{579}{57}{346}{349}{469}812""".replace("\n", "");
        var expected = List.of(
                new RemoveCandidates(0, 2, 7),
                new RemoveCandidates(2, 5, 7)
        );
        SudokuAssertions.assertLogicalSolution(expected, board, UniqueRectangles::uniqueRectanglesType2);
    }

    @Test
    public void type2Test2() {
        var board = """
                ...
                {458}1{467}3{468}9{4578}2{478}""".replace("\n", "");
        var expected = List.of(
                new RemoveCandidates(6, 4, 8),
                new RemoveCandidates(7, 0, 8),
                new RemoveCandidates(7, 6, 8),
                new RemoveCandidates(7, 8, 8),
                new RemoveCandidates(8, 4, 8)
        );
        SudokuAssertions.assertLogicalSolution(expected, board, UniqueRectangles::uniqueRectanglesType2);
    }

    @Test
    public void type2Test3() {
        var board = """
                ...
                165748923""".replace("\n", "");
        var expected = List.of(
                new RemoveCandidates(0, 1, 1),
                new RemoveCandidates(3, 2, 1),
                new RemoveCandidates(4, 2, 1),
                new RemoveCandidates(5, 2, 1)
        );
        SudokuAssertions.assertLogicalSolution(expected, board, UniqueRectangles::uniqueRectanglesType2);
    }

    @Test
    public void type2Test4() {
        var board = """
                319856{47}{47}2
                245973{16}{16}8
                {68}7{68}412935
                ...
                {457}9{17}{16}8{45}{1467}23""".replace("\n", "");
        var expected = List.of(
                new RemoveCandidates(4, 0, 7),
                new RemoveCandidates(6, 2, 1),
                new RemoveCandidates(7, 7, 1),
                new RemoveCandidates(7, 8, 1),
                new RemoveCandidates(8, 2, 7),
                new RemoveCandidates(8, 6, 1)
        );
        SudokuAssertions.assertLogicalSolution(expected, board, UniqueRectangles::uniqueRectanglesType2);
    }

    @Test
    public void type2Test5() {
        var board = """
                654728{19}{139}{39}
                321964{58}7{58}
                978315642
                ...
                {457}{14}{59}{12}863{129}{479}""".replace("\n", "");
        var expected = List.of(
                new RemoveCandidates(5, 0, 2),
                new RemoveCandidates(7, 2, 2)
        );
        SudokuAssertions.assertLogicalSolution(expected, board, UniqueRectangles::uniqueRectanglesType2);
    }

    @Test
    public void type2BTest() {
        var board = """
                {27}4186539{27}
                ...
                98{347}2{357}61{57}{47}""".replace("\n", "");
        var expected = List.of(new RemoveCandidates(1, 6, 8));
        SudokuAssertions.assertLogicalSolution(expected, board, UniqueRectangles::uniqueRectanglesType2);
    }

    @Test
    public void type2CTest() {
        var board = """
                ...
                {139}6{137}{257}{27}{259}48{1359}""".replace("\n", "");
        var expected = List.of(
                new RemoveCandidates(0, 8, 6),
                new RemoveCandidates(2, 8, 6)
        );
        SudokuAssertions.assertLogicalSolution(expected, board, UniqueRectangles::uniqueRectanglesType2);
    }
    ...
    public void type3Test() {
        var board = """
                ...
                {17}43952{17}86""".replace("\n", "");
        var expected = List.of(
                new RemoveCandidates(2, 6, 1),
                new RemoveCandidates(7, 6, 1, 7)
        );
        SudokuAssertions.assertLogicalSolution(expected, board, UniqueRectangles::uniqueRectanglesType3);
    }

    @Test
    public void type3BBTest() {
        var board = """
                ...
                {17}5{47}398{14}62
                92{34}{67}{14}{67}{1345}{345}8""".replace("\n", "");
        var expected = List.of(
                new RemoveCandidates(3, 4, 3),
                new RemoveCandidates(4, 1, 8),
                new RemoveCandidates(4, 8, 3)
        );
        SudokuAssertions.assertLogicalSolution(expected, board, UniqueRectangles::uniqueRectanglesType3);
    }

    @Test
    public void type3BWithTriplePseudoCellsTest1() {
        var board = """
                7529{36}8{16}4{136}
                ...
                {569}3{569}874{169}2{16}""".replace("\n", "");
        var expected = List.of(new RemoveCandidates(7, 0, 6, 9));
        SudokuAssertions.assertLogicalSolution(expected, board, UniqueRectangles::uniqueRectanglesType3BWithTriplePseudoCells);
    }

    @Test
    public void type3BWithTriplePseudoCellsTest2() {
        var board = """
                654728{19}{139}{39}
                321964{58}7{58}
                978315642
                ...
                {457}{14}{59}{12}863{129}{479}""".replace("\n", "");
        var expected = List.of(
                new RemoveCandidates(3, 7, 3),
                new RemoveCandidates(4, 2, 2, 6),
                new RemoveCandidates(5, 6, 2)
        );
        SudokuAssertions.assertLogicalSolution(expected, board, UniqueRectangles::uniqueRectanglesType3BWithTriplePseudoCells);
    }

    @Test
    public void type4Test1() {
        var board = """
                {79}{79}6324815
                85{23}691{24}7{34}
                {24}{234}1785{29}{369}{36}
                ...
                {146}{14}82597{36}{346}""".replace("\n", "");
        var expected = List.of(
                new RemoveCandidates(7, 0, 9),
                new RemoveCandidates(7, 1, 9)
        );
        SudokuAssertions.assertLogicalSolution(expected, board, UniqueRectangles::uniqueRectanglesType4);
    }

    @Test
    public void type4Test2() {
        var board = """
                {4569}8{469}72{59}{456}13
                {345679}{45679}{234679}8{46}1{456}{49}{27}
                1{45679}{24679}3{46}{59}{4568}{489}{27}
        ...
        var expected = List.of(
                ...
                new RemoveCandidates(2, 2, 7)
        );
        SudokuAssertions.assertLogicalSolution(expected, board, UniqueRectangles::uniqueRectanglesType4);
    }

    @Test
    public void type4Test3() {
        var board = """
                12{58}{568}{568}7943
                96{35}{345}1{34}872
                47{38}9{238}{238}156
    ...
    public void type4Test4() {
        var board = """
                ...
                421863579
                {59}63{59}27814
                {5789}{78}{789}4{19}{159}362""".replace("\n", "");
        var expected = List.of(
                new RemoveCandidates(1, 0, 8),
                new RemoveCandidates(1, 3, 7),
                new RemoveCandidates(2, 0, 8),
    ...
    public void type4BTest1() {
        var board = """
                ...
                8{369}52{169}4{39}7{139}""".replace("\n", "");
        var expected = List.of(
                new RemoveCandidates(4, 5, 5),
                new RemoveCandidates(4, 6, 5)
        );
        SudokuAssertions.assertLogicalSolution(expected, board, UniqueRectangles::uniqueRectanglesType4);
    }

    @Test
    public void type4BTest2() {
        var board = """
                173924{58}{58}6
                249865317
                856173429
    ...
    public void type5Test1() {
        var board = """
                ...
                6{48}{278}1{2478}9{257}{257}3""".replace("\n", "");
        var expected = List.of(
                new SetValue(4, 5, 8),
                new SetValue(5, 0, 8)
        );
        SudokuAssertions.assertLogicalSolution(expected, board, UniqueRectangles::uniqueRectanglesType5);
    }

    @Test
    public void type5Test2() {
        var board = """
                ...
                8{247}6{47}93{127}{17}5""".replace("\n", "");
        var expected = List.of(
                new SetValue(6, 1, 4),
                new SetValue(8, 3, 4)
        );
