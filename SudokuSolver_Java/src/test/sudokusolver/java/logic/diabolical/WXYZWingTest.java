...
class WXYZWingTest {
    ...
    public void test1() {
        var board = """
                ...
                {1489}{159}62{145}{58}3{178}{178}""".replace("\n", "");
        var expected = List.of(
                new RemoveCandidates(3, 1, 9),
                new RemoveCandidates(7, 2, 1)
        );
        SudokuAssertions.assertLogicalSolution(expected, board, WXYZWing::wxyzWing);
    }
    ...
    public void test2() {
        var board = """
                ...
                {1489}{159}62{145}{58}3{178}{178}""".replace("\n", "");
        var expected = List.of(new RemoveCandidates(7, 2, 1));
        SudokuAssertions.assertLogicalSolution(expected, board, WXYZWing::wxyzWing);
    }
    ...
    public void test3() {
        var board = """
                ...
                {48}962{14}537{18}""".replace("\n", "");
        var expected = List.of(
                new RemoveCandidates(1, 2, 1),
                new RemoveCandidates(6, 4, 1),
                new RemoveCandidates(8, 4, 4)
        );
        SudokuAssertions.assertLogicalSolution(expected, board, WXYZWing::wxyzWing);
    }
    ...
    public void test4() {
        var board = """
                ...
                2198{456}{56}3{45}7""".replace("\n", "");
        var expected = List.of(
                new RemoveCandidates(5, 4, 6),
    ...
    public void test6() {
        var board = """
                ...
                6{1589}{1579}{34789}{12379}{12479}{2359}{2379}{3578}""".replace("\n", "");
        var expected = List.of(
                new RemoveCandidates(1, 6, 3),
                new RemoveCandidates(1, 7, 3),
                new RemoveCandidates(1, 8, 3)
        );
        SudokuAssertions.assertLogicalSolution(expected, board, WXYZWing::wxyzWing);
    }
