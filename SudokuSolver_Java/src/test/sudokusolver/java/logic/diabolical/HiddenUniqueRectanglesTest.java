...
class HiddenUniqueRectanglesTest {
    ...
    public void type1Test1() {
        var board = """
                ...
                95{48}{48}67231""".replace("\n", "");
        var expected = List.of(
                new RemoveCandidates(0, 5, 2, 4),
                new RemoveCandidates(3, 2, 6)
        );
        SudokuAssertions.assertLogicalSolution(expected, board, HiddenUniqueRectangles::hiddenUniqueRectangles);
    }
    ...
    public void type1Test2() {
        var board = """
                ...
                293{57}48{57}61
                18{47}{257}63{24579}{24579}{27}""".replace("\n", "");
        var expected = List.of(
                new RemoveCandidates(2, 7, 7),
                new RemoveCandidates(8, 6, 7),
    ...
    public void type2Test1() {
        var board = """
                ...
                {16}8{156}937{56}24
                7{49}2{56}1{48}{569}{689}3""".replace("\n", "");
        var expected = List.of(
                new RemoveCandidates(3, 2, 6),
    ...
    public void type2BTest1() {
        var board = """
                ...
                83{12457}{1249}{1247}{12479}{457}6{57}""".replace("\n", "");
        var expected = List.of(
                new RemoveCandidates(7, 2, 7),
    ...
    public void type2BTest2() {
        var board = """
                ...
                65{47}{127}9{17}8{247}3
                293{57}48{57}61
                18{47}{257}63{24579}{2459}{27}""".replace("\n", "");
        var expected = List.of(new RemoveCandidates(8, 6, 7));
        SudokuAssertions.assertLogicalSolution(expected, board, HiddenUniqueRectangles::hiddenUniqueRectangles);
    }
}