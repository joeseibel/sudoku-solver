...
class ExtendedUniqueRectanglesTest {
    @Test
    public void test1() {
        var board = """
                9{16}7{18}243{68}5
                ...
                796{18}5{18}234
                428673591""".replace("\n", "");
        var expected = List.of(new RemoveCandidates(2, 0, 1, 5));
        SudokuAssertions.assertLogicalSolution(expected, board, ExtendedUniqueRectangles::extendedUniqueRectangles);
    }
    ...
    public void test2() {
        var board = """
                ...
                124978653
                8562{13}{13}{49}{49}7
                397{56}4{56}128""".replace("\n", "");
        var expected = List.of(new RemoveCandidates(4, 7, 4, 7));
        SudokuAssertions.assertLogicalSolution(expected, board, ExtendedUniqueRectangles::extendedUniqueRectangles);
    }
    ...
    public void test3() {
        var board = """
                ...
                {139}{13}64782{39}5
                {23}485{123}9{37}6{137}""".replace("\n", "");
        var expected = List.of(new RemoveCandidates(3, 1, 3, 8));
        SudokuAssertions.assertLogicalSolution(expected, board, ExtendedUniqueRectangles::extendedUniqueRectangles);
    }
}