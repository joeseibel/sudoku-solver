...
class JellyfishTest {
    ...
    public void test1() {
        var board = """
                ...
                {12458}{48}63{148}97{258}{258}""".replace("\n", "");
        var expected = List.of(
                new RemoveCandidates(1, 0, 2),
                new RemoveCandidates(1, 7, 2),
                new RemoveCandidates(2, 7, 2),
                new RemoveCandidates(2, 8, 2),
                new RemoveCandidates(6, 0, 2),
                new RemoveCandidates(6, 7, 2),
                new RemoveCandidates(7, 0, 2),
                new RemoveCandidates(7, 8, 2)
        );
        SudokuAssertions.assertLogicalSolution(expected, board, Jellyfish::jellyfish);
    }
    ...
    public void test2() {
        var board = """
                ...
                {18}4236759{18}""".replace("\n", "");
        var expected = List.of(
                new RemoveCandidates(0, 0, 8),
                new RemoveCandidates(0, 2, 8),
                new RemoveCandidates(0, 3, 8),
                new RemoveCandidates(0, 5, 8),
                new RemoveCandidates(0, 8, 8),
                new RemoveCandidates(1, 0, 8),
                new RemoveCandidates(1, 3, 8),
                new RemoveCandidates(1, 5, 8),
                new RemoveCandidates(1, 8, 8),
                new RemoveCandidates(3, 0, 8),
                new RemoveCandidates(3, 3, 8),
                new RemoveCandidates(3, 5, 8),
                new RemoveCandidates(3, 8, 8),
                new RemoveCandidates(4, 0, 8),
                new RemoveCandidates(4, 2, 8),
                new RemoveCandidates(4, 3, 8),
                new RemoveCandidates(4, 5, 8),
                new RemoveCandidates(4, 8, 8),
                new RemoveCandidates(7, 2, 8),
                new RemoveCandidates(7, 3, 8),
                new RemoveCandidates(7, 5, 8)
        );
        SudokuAssertions.assertLogicalSolution(expected, board, Jellyfish::jellyfish);
    }
    ...
    public void test4() {
        var board = """
                ...
                {12679}{269}{169}{235689}{3689}{25689}{349}{34789}{789}""".replace("\n", "");
        var expected = List.of(
                new RemoveCandidates(0, 0, 9),
                new RemoveCandidates(0, 3, 9),
                new RemoveCandidates(0, 5, 9),
                new RemoveCandidates(0, 6, 9),
                new RemoveCandidates(0, 7, 9),
                new RemoveCandidates(2, 0, 9),
                new RemoveCandidates(2, 3, 9),
                new RemoveCandidates(2, 5, 9),
                new RemoveCandidates(2, 7, 9),
                new RemoveCandidates(4, 3, 9),
                new RemoveCandidates(4, 5, 9),
                new RemoveCandidates(4, 6, 9),
                new RemoveCandidates(4, 7, 9),
                new RemoveCandidates(5, 0, 9),
                new RemoveCandidates(5, 3, 9),
                new RemoveCandidates(5, 5, 9),
                new RemoveCandidates(5, 7, 9),
                new RemoveCandidates(8, 0, 9),
                new RemoveCandidates(8, 3, 9),
                new RemoveCandidates(8, 5, 9),
                new RemoveCandidates(8, 6, 9),
                new RemoveCandidates(8, 7, 9)
        );
        SudokuAssertions.assertLogicalSolution(expected, board, Jellyfish::jellyfish);
    }
    ...
    public void test5() {
        var board = """
                ...
                {79}2{679}{568}13{589}{59}4""".replace("\n", "");
        var expected = List.of(
                new RemoveCandidates(3, 2, 5),
                new RemoveCandidates(3, 6, 5),
                new RemoveCandidates(3, 8, 5),
                new RemoveCandidates(8, 6, 5)
        );
        SudokuAssertions.assertLogicalSolution(expected, board, Jellyfish::jellyfish);
    }
    ...
    public void test6() {
        var board = """
                ...
                1{45}2{4578}3{578}69{78}""".replace("\n", "");
        var expected = List.of(
                new RemoveCandidates(0, 1, 4, 5),
                new RemoveCandidates(0, 6, 4, 5),
                new RemoveCandidates(4, 1, 4, 5),
                new RemoveCandidates(4, 3, 4, 5),
                new RemoveCandidates(5, 1, 4, 5),
                new RemoveCandidates(5, 3, 4, 5),
                new RemoveCandidates(5, 5, 5),
                new RemoveCandidates(5, 6, 4, 5),
                new RemoveCandidates(7, 1, 4, 5),
                new RemoveCandidates(7, 3, 4, 5),
                new RemoveCandidates(7, 5, 5),
                new RemoveCandidates(7, 6, 5)
        );
        SudokuAssertions.assertLogicalSolution(expected, board, Jellyfish::jellyfish);
    }
    ...
    public void test7() {
        var board = """
                ...
                61{578}{2578}{48}{2457}{2458}39""".replace("\n", "");
        var expected = List.of(
                new RemoveCandidates(2, 6, 5, 8),
                new RemoveCandidates(4, 2, 5),
                new RemoveCandidates(5, 2, 5, 8),
                new RemoveCandidates(6, 2, 5, 8),
                new RemoveCandidates(6, 3, 5, 8),
                new RemoveCandidates(6, 5, 5)
        );
        SudokuAssertions.assertLogicalSolution(expected, board, Jellyfish::jellyfish);
    }
    ...
    public void test8() {
        var board = """
                ...
                {2345678}{34568}{2678}{124678}{178}{28}{38}9{268}""".replace("\n", "");
        var expected = List.of(
                new RemoveCandidates(0, 0, 8),
                new RemoveCandidates(0, 1, 8),
                new RemoveCandidates(0, 2, 8),
                new RemoveCandidates(0, 3, 8),
                new RemoveCandidates(0, 7, 8),
                new RemoveCandidates(2, 0, 8),
                new RemoveCandidates(2, 1, 8),
                new RemoveCandidates(2, 3, 8),
                ...
                new RemoveCandidates(7, 1, 8),
                new RemoveCandidates(7, 3, 8),
                new RemoveCandidates(7, 7, 8),
                new RemoveCandidates(8, 0, 8),
                new RemoveCandidates(8, 1, 8),
                new RemoveCandidates(8, 2, 8),
                new RemoveCandidates(8, 3, 8)
        );
        SudokuAssertions.assertLogicalSolution(expected, board, Jellyfish::jellyfish);
    }
    ...
    public void test9() {
        var board = """
                ...
                {237}96{237}{37}5418""".replace("\n", "");
        var expected = List.of(
                new RemoveCandidates(0, 0, 7),
                new RemoveCandidates(0, 3, 7),
                new RemoveCandidates(0, 4, 7),
                new RemoveCandidates(0, 5, 7),
                new RemoveCandidates(0, 7, 7),
                new RemoveCandidates(1, 0, 7),
                new RemoveCandidates(1, 3, 7),
                new RemoveCandidates(1, 4, 7),
                new RemoveCandidates(1, 7, 7),
                new RemoveCandidates(4, 0, 7),
                new RemoveCandidates(4, 3, 7),
                new RemoveCandidates(4, 4, 7),
                new RemoveCandidates(4, 5, 7),
                new RemoveCandidates(4, 7, 7),
                new RemoveCandidates(6, 0, 7),
                new RemoveCandidates(6, 3, 7),
                new RemoveCandidates(6, 4, 7),
                new RemoveCandidates(6, 7, 7),
                new RemoveCandidates(7, 0, 7),
