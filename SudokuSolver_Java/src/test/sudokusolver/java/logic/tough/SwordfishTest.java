...
class SwordfishTest {
    ...
    public void test1() {
        var board = """
                ...
                96{18}7423{18}5""".replace("\n", "");
        var expected = List.of(
                new RemoveCandidates(1, 1, 8),
                new RemoveCandidates(1, 7, 8),
                new RemoveCandidates(2, 1, 8),
                new RemoveCandidates(2, 8, 8),
                new RemoveCandidates(3, 5, 8)
        );
        SudokuAssertions.assertLogicalSolution(expected, board, Swordfish::swordfish);
    }
    ...
    public void test2() {
        var board = """
                ...
                485{29}7136{29}
                6{79}3{24589}{48}{2589}{2579}{579}1""".replace("\n", "");
        var expected = List.of(
                new RemoveCandidates(2, 3, 9),
                new RemoveCandidates(2, 5, 9),
                new RemoveCandidates(6, 6, 9),
    ...
    public void test3() {
        var board = """
                ...
                {15}{158}96743{58}2
                27{46}358{146}9{14}""".replace("\n", "");
        var expected = List.of(
                new RemoveCandidates(1, 1, 4),
                new RemoveCandidates(1, 8, 4),
                new RemoveCandidates(4, 1, 4),
                new RemoveCandidates(4, 2, 4),
                new RemoveCandidates(4, 6, 4),
                new RemoveCandidates(4, 8, 4),
                new RemoveCandidates(5, 2, 4),
                new RemoveCandidates(5, 6, 4),
                new RemoveCandidates(6, 2, 4),
                new RemoveCandidates(6, 6, 4),
    ...
    public void test4() {
        var board = """
                ...
                41{2359}6{2358}{23578}{3789}{579}{3589}""".replace("\n", "");
        var expected = List.of(
                new RemoveCandidates(1, 2, 2),
                new RemoveCandidates(1, 4, 2),
                new RemoveCandidates(1, 6, 2),
                new RemoveCandidates(4, 0, 2),
                new RemoveCandidates(4, 2, 2),
                new RemoveCandidates(4, 4, 2),
                new RemoveCandidates(4, 5, 2),
                new RemoveCandidates(4, 6, 2),
                new RemoveCandidates(5, 2, 2),
                new RemoveCandidates(5, 5, 2),
    ...
    public void test5() {
        var board = """
                ...
                6{78}9{78}25314""".replace("\n", "");
        var expected = List.of(
                new RemoveCandidates(2, 1, 8),
                new RemoveCandidates(2, 2, 8),
                new RemoveCandidates(2, 3, 8),
                new RemoveCandidates(3, 2, 7),
                new RemoveCandidates(6, 1, 7, 8),
                new RemoveCandidates(6, 2, 7, 8),
                new RemoveCandidates(7, 1, 7, 8),
                new RemoveCandidates(7, 2, 7, 8),
                new RemoveCandidates(7, 3, 7, 8)
        );
        SudokuAssertions.assertLogicalSolution(expected, board, Swordfish::swordfish);
    }
}