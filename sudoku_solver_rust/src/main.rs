...
use logic::{
    ...
    extreme::{empty_rectangles, finned_x_wing, grouped_x_cycles},
    simple::{
...
fn perform_next_solution(board: &Board<Cell>) -> Vec<BoardModification> {
    let solutions = [
        ...
        xy_chains::xy_chains,
        medusa::medusa_rule_1,
        medusa::medusa_rule_2,
        medusa::medusa_rule_3,
        medusa::medusa_rule_4,
        medusa::medusa_rule_5,
        medusa::medusa_rule_6,
        jellyfish::jellyfish,
        unique_rectangles::unique_rectangles_type_1,
        unique_rectangles::unique_rectangles_type_2,
        unique_rectangles::unique_rectangles_type_3,
        ...
        wxyz_wing::wxyz_wing,
        aligned_pair_exclusion::aligned_pair_exclusion,
