  ...
  test("rule 3 test 1") {
    val board =
      """
        ...
        |""".stripMargin.replace("\n", "")
    val expected = Seq(RemoveCandidates(2, 1, 8))
  ...
  test("rule 3 test 2") {
    val board =
      """
        ...
        |21957{68}3{68}4
        |""".stripMargin.replace("\n", "")
    val expected = Seq(RemoveCandidates(7, 8, 2, 9))
    assertLogicalSolution(expected, board, medusaRule3)
  }
  ...
  test("rule 3 test 3") {
    val board =
      """
        ...
        |""".stripMargin.replace("\n", "")
    val expected = Seq(RemoveCandidates(8, 6, 9))
    assertLogicalSolution(expected, board, medusaRule3)
  }
  ...
  test("rule 5 test 6") {
    val board =
      """
        ...
        |{189}{369}{13}{489}25{6789}{689}{467}
        |""".stripMargin.replace("\n", "")
    val expected = Seq(RemoveCandidates(5, 1, 2))
    assertLogicalSolution(expected, board, medusaRule5)
  }
