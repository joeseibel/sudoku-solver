  ...
  test("test 1") {
    val board =
      """
        ...
        |7563{14}9{14}82
        |""".stripMargin.replace("\n", "")
    val expected = Seq(SetValue(3, 7, 2))
    assertLogicalSolution(expected, board, bug(_).toSeq)
  }
  ...
  test("test 2") {
    val board =
      """
        ...
        |157{38}{68}{36}429
        |""".stripMargin.replace("\n", "")
    val expected = Seq(SetValue(4, 1, 6))
    assertLogicalSolution(expected, board, bug(_).toSeq)
  }
  ...
  test("test 3") {
    val board =
      """
        ...
        |813647952
        |""".stripMargin.replace("\n", "")
    val expected = Seq(SetValue(5, 2, 8))
    assertLogicalSolution(expected, board, bug(_).toSeq)
  }
  ...
  test("test 4") {
    val board =
      """
        ...
        |419782536
        |""".stripMargin.replace("\n", "")
    val expected = Seq(SetValue(7, 4, 4))
    assertLogicalSolution(expected, board, bug(_).toSeq)
  }
  ...
  test("test 5") {
    val board =
      """
        ...
        |{89}653427{89}1
        |""".stripMargin.replace("\n", "")
    val expected = Seq(SetValue(1, 2, 7))
    assertLogicalSolution(expected, board, bug(_).toSeq)
  }
  ...
  test("test 6") {
    val board =
      """
        ...
        |238195647
        |""".stripMargin.replace("\n", "")
    val expected = Seq(SetValue(4, 4, 8))
    assertLogicalSolution(expected, board, bug(_).toSeq)
  }
  ...
  test("test 7") {
    val board =
      """
        ...
        |61{45}7{45}8239
        |""".stripMargin.replace("\n", "")
    val expected = Seq(SetValue(7, 1, 2))
    assertLogicalSolution(expected, board, bug(_).toSeq)
  }
  ...
  test("test 8") {
    val board =
      """
        ...
        |561394287
        |""".stripMargin.replace("\n", "")
    val expected = Seq(SetValue(0, 4, 4))
    assertLogicalSolution(expected, board, bug(_).toSeq)
  }